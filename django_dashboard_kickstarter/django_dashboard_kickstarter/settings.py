"""
Django settings for django_dashboard_kickstarter project.
...
ROOT_URLCONF = 'django_dashboard_kickstarter.urls'
...
WSGI_APPLICATION = 'django_dashboard_kickstarter.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/kickstarter.log'),
